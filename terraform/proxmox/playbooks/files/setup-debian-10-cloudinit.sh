...
then
	...
	qm create "${VMID}" -name "${VMNAME}" -memory 1024 -net0 virtio,bridge=vmbr0 -cores 1 -sockets 1 -cpu cputype=kvm64 -description "debian 10 template" -kvm 1 -numa 1
	qm importdisk "${VMID}" debian-10-amd64.qcow2 local-lvm
